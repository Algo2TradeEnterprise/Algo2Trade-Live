...
#End Region
        ...
        Public MustOverride Async Function PlaceCOLimitMISOrderAsync(ByVal tradeExchange As String, ByVal tradingSymbol As String, ByVal transaction As IOrder.TypeOfTransaction, ByVal quantity As Integer, ByVal price As Decimal, ByVal triggerPrice As Decimal, ByVal tag As String) As Task(Of Dictionary(Of String, Object))

...
Namespace Adapter
    Public Class AliceInformationCollector
...
#End Region
        ...
        Public Overrides Async Function ConnectCollectorAsync() As Task
            ...
            RemoveHandler Me.CollectorInformationAsync, AddressOf currentAliceStrategyController.OnCollectorInformationAsync
            RemoveHandler Me.CollectorError, AddressOf currentAliceStrategyController.OnCollectorError
            _cts.Token.ThrowIfCancellationRequested()
            AddHandler Me.CollectorInformationAsync, AddressOf currentAliceStrategyController.OnCollectorInformationAsync
            AddHandler Me.CollectorError, AddressOf currentAliceStrategyController.OnCollectorError
        End Function

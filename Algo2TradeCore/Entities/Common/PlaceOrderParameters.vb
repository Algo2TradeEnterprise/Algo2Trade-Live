...
Namespace Entities
    Public Class PlaceOrderParameters
        ...
        Public Overrides Function ToString() As String
            Return String.Format("{0},{1},{2},{3},{4},{5},{6}", EntryDirection.ToString(), Quantity, Price, TriggerPrice, SquareOffValue, StoplossValue, If(SignalCandle Is Nothing, "Nothing", SignalCandle.SnapshotDateTime.ToString()))
        End Function
    End Class
End Namespace
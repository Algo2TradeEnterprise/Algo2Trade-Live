    ...
    Public Sub New(ByVal associatedInstrument As IInstrument,
        ...
        If Me.ParentStrategy.IsStrategyCandleStickBased Then
            If Me.ParentStrategy.UserSettings.SignalTimeFrame > 0 Then
                ...
                {New PSARConsumer(chartConsumer, CType(Me.ParentStrategy.UserSettings, MomentumReversalUserInputs).MinimumAF, CType(Me.ParentStrategy.UserSettings, MomentumReversalUserInputs).MaximumAF)}
                RawPayloadDependentConsumers.Add(chartConsumer)
                _dummyPSARConsumer = New PSARConsumer(chartConsumer, CType(Me.ParentStrategy.UserSettings, MomentumReversalUserInputs).MinimumAF, CType(Me.ParentStrategy.UserSettings, MomentumReversalUserInputs).MaximumAF)
            Else

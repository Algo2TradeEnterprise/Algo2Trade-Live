...
#End Region
    ...
    Public Async Function GetInstrumentDataAsync(ByVal allInstruments As IEnumerable(Of IInstrument), ByVal bannedStock As List(Of String)) As Task(Of List(Of String))
                                                                                                       ...
                                                                                                       If rawCashInstrument IsNot Nothing Then
                                                                                                           ...
                                                                                                           If eodHistoricalData IsNot Nothing AndAlso eodHistoricalData.Count > 100 Then
                                                                                                               ...
                                                                                                               If eodHistoricalData.LastOrDefault.Value.ClosePrice.Value >= _userInputs.MinimumStockPrice AndAlso
                                                                                                                    eodHistoricalData.LastOrDefault.Value.ClosePrice.Value <= _userInputs.MaximumStockPrice AndAlso
                                                                                                                    eodHistoricalData.LastOrDefault.Value.Volume.Value >= _userInputs.MinimumVolume Then
                                                                                                                   Dim atrPayload As Dictionary(Of Date, Decimal) = Nothing
                                                                                                                   CalculateATR(_userInputs.ATRPeriod, eodHistoricalData, atrPayload)
                                                                                                                   _cts.Token.ThrowIfCancellationRequested()

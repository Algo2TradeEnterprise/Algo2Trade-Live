...
Public Class NFOUserInputs
    ...
    Public Shared Property SettingsFileName As String = Path.Combine(My.Application.Info.DirectoryPath, "Swing With Exit.Strategy.a2t")

    Public Property TelegramBotAPIKey As String
    Public Property TelegramTradeChatID As String
    Public Property TelegramCapitalChatID As String

    Public Property InitialCapital As Decimal
    Public Property MaxCapitalToBeAvailable As Decimal
    Public Property CapitalCheckFrequency As Decimal
    ...
    Public Property MartingaleMultiplier As Decimal
    Public Property MaxMartingaleIteration As Integer

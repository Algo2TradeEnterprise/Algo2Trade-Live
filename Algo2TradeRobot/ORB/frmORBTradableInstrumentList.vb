Public Class frmORBTradableInstrumentList

    Private _TradableStrategyInstruments As IEnumerable(Of ORBStrategyInstrument)
    Public Sub New(ByVal associatedTradableInstruments As IEnumerable(Of ORBStrategyInstrument))
        InitializeComponent()
        Me._TradableStrategyInstruments = associatedTradableInstruments
    End Sub

    Private Sub frmORBTradableInstrumentList_Load(sender As Object, e As EventArgs) Handles MyBase.Load

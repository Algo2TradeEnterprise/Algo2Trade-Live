...
Public Class frmORBSettings

    Private _cts As CancellationTokenSource = Nothing
    Private _settings As ORBUserInputs = Nothing
    Private _settingsFilename As String = ORBUserInputs.SettingsFileName
    Private _strategyRunning As Boolean = False

    Public Sub New(ByRef userInputs As ORBUserInputs, ByVal strategyRunning As Boolean)
        InitializeComponent()
        _settings = userInputs
        _strategyRunning = strategyRunning
    End Sub

    Private Sub frmORBSettings_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub btnSave_Click(sender As Object, e As EventArgs) Handles btnSave.Click
        Try
            ...
            If _settings Is Nothing Then _settings = New ORBUserInputs
    ...
    Private Sub LoadSettings()
        If File.Exists(_settingsFilename) Then
            _settings = Utilities.Strings.DeserializeToCollection(Of ORBUserInputs)(_settingsFilename)

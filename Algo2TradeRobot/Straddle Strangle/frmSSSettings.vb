...
Public Class frmSSSettings

    Private _cts As CancellationTokenSource = Nothing
    Private _settings As SSUserInputs = Nothing
    Private _settingsFilename As String = SSUserInputs.SettingsFileName
    Private _strategyRunning As Boolean = False

    Public Sub New(ByRef userInputs As SSUserInputs, ByVal strategyRunning As Boolean)
        InitializeComponent()
        _settings = userInputs
        _strategyRunning = strategyRunning
    End Sub

    Private Sub frmssSettings_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub btnSave_Click(sender As Object, e As EventArgs) Handles btnSave.Click
        Try
            ...
            If _settings Is Nothing Then _settings = New SSUserInputs
    ...
    Private Sub LoadSettings()
        If File.Exists(_settingsFilename) Then
            _settings = Utilities.Strings.DeserializeToCollection(Of SSUserInputs)(_settingsFilename)
    ...
    Private Sub SaveSettings()
        ...
        Utilities.Strings.SerializeFromCollection(Of SSUserInputs)(_settingsFilename, _settings)
    End Sub

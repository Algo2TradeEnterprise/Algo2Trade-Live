Public Class frmSSTradableInstrumentList

    Private _TradableStrategyInstruments As IEnumerable(Of SSStrategyInstrument)
    Public Sub New(ByVal associatedTradableInstruments As IEnumerable(Of SSStrategyInstrument))
        InitializeComponent()
        Me._TradableStrategyInstruments = associatedTradableInstruments
    End Sub

    Private Sub frmSSTradableInstrumentList_Load(sender As Object, e As EventArgs) Handles MyBase.Load

...
Public Class frmStraddleSettings

    Private _cts As CancellationTokenSource = Nothing
    Private _settings As StraddleUserInputs = Nothing
    Private _settingsFilename As String = StraddleUserInputs.SettingsFileName
    Private _strategyRunning As Boolean = False

    Public Sub New(ByRef userInputs As StraddleUserInputs, ByVal strategyRunning As Boolean)
        InitializeComponent()
        _settings = userInputs
        _strategyRunning = strategyRunning
    End Sub

    Private Sub frmStraddleSettings_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub btnSave_Click(sender As Object, e As EventArgs) Handles btnSave.Click
        Try
            ...
            If _settings Is Nothing Then _settings = New StraddleUserInputs
    ...
    Private Sub LoadSettings()
        If File.Exists(_settingsFilename) Then
            _settings = Utilities.Strings.DeserializeToCollection(Of StraddleUserInputs)(_settingsFilename)
    ...
    Private Sub SaveSettings()
        ...
        Utilities.Strings.SerializeFromCollection(Of StraddleUserInputs)(_settingsFilename, _settings)
    End Sub

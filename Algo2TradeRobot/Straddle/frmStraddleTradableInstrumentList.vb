Public Class frmStraddleTradableInstrumentList

    Private _TradableStrategyInstruments As IEnumerable(Of StraddleStrategyInstrument)
    Public Sub New(ByVal associatedTradableInstruments As IEnumerable(Of StraddleStrategyInstrument))
        InitializeComponent()
        Me._TradableStrategyInstruments = associatedTradableInstruments
    End Sub

    Private Sub frmStraddleTradableInstrumentList_Load(sender As Object, e As EventArgs) Handles MyBase.Load

...
#End Region
            ...
            _nfoStrategyToExecute = New NFOStrategy(_commonController, 2, _nfoUserInputs, Math.Ceiling(Math.Ceiling(_nfoUserInputs.LoopBackPeriod / Math.Ceiling(375 / _nfoUserInputs.SignalTimeFrame)) * 2), _cts)

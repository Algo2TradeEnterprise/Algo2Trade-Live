...
Public Class frmStrangleSettings

    Private _cts As CancellationTokenSource = Nothing
    Private _settings As StrangleUserInputs = Nothing
    Private _settingsFilename As String = StrangleUserInputs.SettingsFileName
    Private _strategyRunning As Boolean = False

    Public Sub New(ByRef userInputs As StrangleUserInputs, ByVal strategyRunning As Boolean)
        InitializeComponent()
        _settings = userInputs
        _strategyRunning = strategyRunning
    End Sub

    Private Sub frmStrangleSettings_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub btnSave_Click(sender As Object, e As EventArgs) Handles btnSave.Click
        Try
            ...
            If _settings Is Nothing Then _settings = New StrangleUserInputs
    ...
    Private Sub LoadSettings()
        If File.Exists(_settingsFilename) Then
            _settings = Utilities.Strings.DeserializeToCollection(Of StrangleUserInputs)(_settingsFilename)
    ...
    Private Sub SaveSettings()
        ...
        Utilities.Strings.SerializeFromCollection(Of StrangleUserInputs)(_settingsFilename, _settings)
    End Sub

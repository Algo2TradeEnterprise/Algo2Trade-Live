                    ...
                    While True
                        ...
                        If optionSelectionDone Then
                            ...
                            If Me.TradableInstrument.IsHistoricalCompleted AndAlso Me.TradableInstrument.LastTick.Timestamp.Value >= userSettings.TradeStartTime AndAlso
                                runningCandlePayload IsNot Nothing AndAlso stConsumer.ConsumerPayloads.ContainsKey(runningCandlePayload.PreviousPayload.SnapshotDateTime) AndAlso
                                runningCandlePayload.PreviousPayload IsNot Nothing AndAlso runningCandlePayload.SnapshotDateTime >= userSettings.TradeStartTime Then
                                ...
                                Else
                                    ...
                                    For Each runningInstrument In _myOptionStrategyInstruments
                                        ...
                                        End If
                                    Next
                                    Dim supertrend As SupertrendConsumer.SupertrendPayload = stConsumer.ConsumerPayloads(runningCandlePayload.PreviousPayload.SnapshotDateTime)
                                    ...
                                    If supertrendATM <> Decimal.MinValue Then
                                        If supertrend.SupertrendColor = Color.Green Then
                                            ...
                                            OnHeartbeat(String.Format("Supertrend={0}, Supertrend Color={1}, Close={2}, Supertrend Strike={3}, Close Strike={4}",
                                                                      ...
                                                                      runningCandlePayload.PreviousPayload.ClosePrice.Value, supertrendATM, closeATM))

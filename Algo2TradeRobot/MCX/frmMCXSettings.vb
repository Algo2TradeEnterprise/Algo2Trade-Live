...
Public Class frmMCXSettings
    ...
    Public Sub New(ByRef userInputs As MCXUserInputs, ByVal strategyRunning As Boolean)
        InitializeComponent()
    ...
    Private Sub SaveSettings()
        ...
        _settings.MaxTurnoverPerTrade = Math.Abs(CDec(txtMaxTurnoverPerTrade.Text))

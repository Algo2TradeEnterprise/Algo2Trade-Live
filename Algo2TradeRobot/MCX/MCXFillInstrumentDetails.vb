...
Public Class MCXFillInstrumentDetails
...
#End Region
    ...
    Private ReadOnly _parentStrategy As MCXStrategy
    Private ReadOnly _userInputs As MCXUserInputs
    ...
    Public Sub New(ByVal canceller As CancellationTokenSource, ByVal parentStrategy As MCXStrategy)
        _cts = canceller

    ...
    Public Sub New(ByVal associatedInstrument As IInstrument,
        ...
        If Me.ParentStrategy.IsStrategyCandleStickBased Then
            If Me.ParentStrategy.UserSettings.SignalTimeFrame > 0 Then
                ...
                _dummySupertrendConsumer = New SupertrendConsumer(chartConsumer, CType(Me.ParentStrategy.UserSettings, MCXUserInputs).Period, CType(Me.ParentStrategy.UserSettings, MCXUserInputs).Multiplier)
            Else

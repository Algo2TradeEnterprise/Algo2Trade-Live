...
#End Region
    ...
    Public Sub New(ByVal associatedInstrument As IInstrument,
        ...
        If Me.ParentStrategy.IsStrategyCandleStickBased Then
            If Me.ParentStrategy.UserSettings.SignalTimeFrame > 0 Then
                ...
                {New SupertrendConsumer(chartConsumer, CType(Me.ParentStrategy.UserSettings, MCXUserInputs).Period, CType(Me.ParentStrategy.UserSettings, MCXUserInputs).Multiplier)}
                RawPayloadDependentConsumers.Add(chartConsumer)
                _dummyLFSupertrendConsumer = New SupertrendConsumer(chartConsumer, CType(Me.ParentStrategy.UserSettings, MCXUserInputs).Period, CType(Me.ParentStrategy.UserSettings, MCXUserInputs).Multiplier)

                Dim chartConsumer2 As PayloadToChartConsumer = New PayloadToChartConsumer(CType(Me.ParentStrategy.UserSettings, MCXUserInputs).MiddleTimeframe)
                chartConsumer2.OnwardLevelConsumers = New List(Of IPayloadConsumer) From
                {New SupertrendConsumer(chartConsumer2, CType(Me.ParentStrategy.UserSettings, MCXUserInputs).Period, CType(Me.ParentStrategy.UserSettings, MCXUserInputs).Multiplier)}
                RawPayloadDependentConsumers.Add(chartConsumer2)
                _dummyMFSupertrendConsumer = New SupertrendConsumer(chartConsumer2, CType(Me.ParentStrategy.UserSettings, MCXUserInputs).Period, CType(Me.ParentStrategy.UserSettings, MCXUserInputs).Multiplier)

                Dim chartConsumer3 As PayloadToChartConsumer = New PayloadToChartConsumer(CType(Me.ParentStrategy.UserSettings, MCXUserInputs).HigherTimeframe)
                chartConsumer3.OnwardLevelConsumers = New List(Of IPayloadConsumer) From
                {New SupertrendConsumer(chartConsumer3, CType(Me.ParentStrategy.UserSettings, MCXUserInputs).Period, CType(Me.ParentStrategy.UserSettings, MCXUserInputs).Multiplier)}
                RawPayloadDependentConsumers.Add(chartConsumer3)
                _dummyHFSupertrendConsumer = New SupertrendConsumer(chartConsumer3, CType(Me.ParentStrategy.UserSettings, MCXUserInputs).Period, CType(Me.ParentStrategy.UserSettings, MCXUserInputs).Multiplier)
            Else
    ...
    Protected Overrides Async Function IsTriggerReceivedForPlaceOrderAsync(ByVal forcePrint As Boolean) As Task(Of List(Of Tuple(Of ExecuteCommandAction, PlaceOrderParameters, String)))
        ...
        Dim userSettings As MCXUserInputs = Me.ParentStrategy.UserSettings

    ...
    Public Sub New(ByVal associatedInstrument As IInstrument,
        ...
        If Me.ParentStrategy.IsStrategyCandleStickBased Then
            If Me.ParentStrategy.UserSettings.SignalTimeFrame > 0 Then
                ...
                Dim chartConsumer2 As PayloadToChartConsumer = New PayloadToChartConsumer(CType(Me.ParentStrategy.UserSettings, CDSUserInputs).MiddleTimeframe)
                ...
                _dummyMFSupertrendConsumer = New SupertrendConsumer(chartConsumer2, CType(Me.ParentStrategy.UserSettings, CDSUserInputs).Period, CType(Me.ParentStrategy.UserSettings, CDSUserInputs).Multiplier)

                Dim chartConsumer3 As PayloadToChartConsumer = New PayloadToChartConsumer(CType(Me.ParentStrategy.UserSettings, CDSUserInputs).HigherTimeframe)
                chartConsumer3.OnwardLevelConsumers = New List(Of IPayloadConsumer) From
                {New SupertrendConsumer(chartConsumer3, CType(Me.ParentStrategy.UserSettings, CDSUserInputs).Period, CType(Me.ParentStrategy.UserSettings, CDSUserInputs).Multiplier)}
                RawPayloadDependentConsumers.Add(chartConsumer3)
                _dummyHFSupertrendConsumer = New SupertrendConsumer(chartConsumer3, CType(Me.ParentStrategy.UserSettings, CDSUserInputs).Period, CType(Me.ParentStrategy.UserSettings, CDSUserInputs).Multiplier)
            Else

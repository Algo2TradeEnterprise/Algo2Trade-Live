Public Class frmCDSTradableInstrumentList

    Private _TradableInstruments As IEnumerable(Of CDSStrategyInstrument)
    Public Sub New(ByVal associatedTradableInstruments As IEnumerable(Of CDSStrategyInstrument))
        InitializeComponent()
        Me._TradableInstruments = associatedTradableInstruments
    End Sub

    Private Sub frmCDSTradableInstrumentList_Load(sender As Object, e As EventArgs) Handles MyBase.Load

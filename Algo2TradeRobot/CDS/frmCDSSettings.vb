...
Public Class frmCDSSettings

    Private _cts As CancellationTokenSource = Nothing
    Private _settings As CDSUserInputs = Nothing
    Private _settingsFilename As String = CDSUserInputs.SettingsFileName

    Public Sub New(ByRef userInputs As CDSUserInputs)
        InitializeComponent()
        _settings = userInputs
    End Sub

    Private Sub frmCDSSettings_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        LoadSettings()
    End Sub
    Private Sub btnSave_Click(sender As Object, e As EventArgs) Handles btnSave.Click
        Try
            _cts = New CancellationTokenSource
            If _settings Is Nothing Then _settings = New CDSUserInputs
    ...
    Private Sub LoadSettings()
        If File.Exists(_settingsFilename) Then
            _settings = Utilities.Strings.DeserializeToCollection(Of CDSUserInputs)(_settingsFilename)
    ...
    Private Sub SaveSettings()
        ...
        Utilities.Strings.SerializeFromCollection(Of CDSUserInputs)(_settingsFilename, _settings)
    End Sub

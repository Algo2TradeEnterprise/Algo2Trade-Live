...
#End Region
    ...
    Public Sub New(ByVal associatedParentController As APIStrategyController,
                   ...
                   ByVal userSettings As CDSUserInputs,
    ...
    Public Overrides Async Function CreateTradableStrategyInstrumentsAsync(ByVal allInstruments As IEnumerable(Of IInstrument), ByVal bannedInstruments As List(Of String)) As Task(Of Boolean)
        ...
        If allInstruments IsNot Nothing AndAlso allInstruments.Count > 0 Then
            Dim mrUserInputs As CDSUserInputs = Me.UserSettings
            If mrUserInputs.InstrumentsData IsNot Nothing AndAlso mrUserInputs.InstrumentsData.Count > 0 Then
                ...
                If ignoredStocklist IsNot Nothing AndAlso ignoredStocklist.Count > 0 Then
                    ...
                    MessageBox.Show(String.Format("Unable to fetch '{0}' these stocks in 'CDS' segment", stocksName.Substring(1).ToUpper), "Stock Selection", MessageBoxButtons.OK, MessageBoxIcon.Warning)
                End If
        ...
        If retTradableInstrumentsAsPerStrategy IsNot Nothing AndAlso retTradableInstrumentsAsPerStrategy.Count > 0 Then
            ...
            Dim retTradableStrategyInstruments As List(Of CDSStrategyInstrument) = Nothing
            ...
            For Each runningTradableInstrument In retTradableInstrumentsAsPerStrategy
                _cts.Token.ThrowIfCancellationRequested()
                If retTradableStrategyInstruments Is Nothing Then retTradableStrategyInstruments = New List(Of CDSStrategyInstrument)
                Dim runningTradableStrategyInstrument As New CDSStrategyInstrument(runningTradableInstrument, Me, False, _cts)
    ...
    Public Overrides Async Function MonitorAsync() As Task
        ...
        Try
            ...
            For Each tradableStrategyInstrument As CDSStrategyInstrument In TradableStrategyInstruments
                _cts.Token.ThrowIfCancellationRequested()
